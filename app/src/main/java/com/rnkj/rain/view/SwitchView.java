...
public class SwitchView extends FrameLayout {
     ...
     * LeftSwitch
     */
    private static final String TEXT_LEFT_SWITCH = "湿";
    /**
     * RightSwitch
     */
    private static final String TEXT_RIGHT_SWITCH = "干";
    /**
     * TYPE - LEFT
     */
...
//       setBackgroundColor(getResources().getColor(R.color.background_grad));
        // step.1: add floating layer in bottom(maybe called 'sediment layer')
        mFloatingLayer = new ImageView(getContext());
        mFloatingLayer.setBackgroundResource(R.drawable.onback);
//       mFloatingLayer.setBackgroundColor(getResources().getColor(R.color.status_press));
        ...
        mLeftSwitch.setTextColor(Color.WHITE);
    ...
    public void switching() {
        ...
        if (type == TYPE_LEFT) {
            ...
            mRightSwitch.setTextColor(Color.WHITE);
            openClickEvent();
